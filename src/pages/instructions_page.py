...
st.write("This feedback shows you whether the AI thinks the statement is a lie or a truth and how confident it is in its classification. Your goal is to change the AI's confidence score (lower the percentage shown) through your rewrites.")
st.write("In total you will have 10 attempts per statement to change the confidence score as much as possible. If you manage to change the class the AI thinks the statement belongs to (truth or lie), you will move on to the next statement.")
st.write("You will now undergo a guided training procedure to make you familiar with the task.")
